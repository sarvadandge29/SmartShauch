...
const MOCK_FEEDBACKS: Record<string, FeedbackItem[]> = {
  'TL-001': [
    { id: '1', userName: 'John D.', rating: 4, cleanliness: 4, issue: 'Bad Smell', comment: 'Clean but needs better ventilation', timeAgo: '2 hours ago' },
    { id: '2', userName: 'Sarah M.', rating: 2, cleanliness: 2, issue: 'No Water', comment: 'No water supply', timeAgo: '5 hours ago' },
  ],
  'TL-002': [
    { id: '3', userName: 'Mike R.', rating: 5, cleanliness: 5, issue: 'Clean', comment: 'Very clean', timeAgo: '1 day ago' },
    { id: '4', userName: 'Emily W.', rating: 3, cleanliness: 3, issue: 'Broken Flush', comment: 'Flush not working', timeAgo: '1 day ago' },
  ],
  'TL-003': [
    { id: '5', userName: 'Alex K.', rating: 1, cleanliness: 1, issue: 'Dirty', comment: 'Very dirty', timeAgo: '2 days ago' },
  ],
};
...
const Feedback = () => {
  ...
  const handleSubmitFeedback = () => {
    ...
    if (cleanliness === 0) {
      Alert.alert('Error', 'Please provide cleanliness rating');
      return;
    }
  ...
  return (
    <ScrollView className="flex-1" style={{ backgroundColor: lightGray }}>
      <View className="p-4">
        {/* Header */}
        <View className="flex-row justify-between items-center mb-4 mt-4">
          <Text className="text-2xl font-bold" style={{ fontFamily: getFontFamily('serif'), color: primaryBlue }}>
            Feedback
          </Text>
          <TouchableOpacity 
            onPress={() => router.back()}
          ...
          >
            <Ionicons name="close" size={24} color={grayText} />
          </TouchableOpacity>
        </View>
        ...
        <View className="bg-white rounded-xl p-4 mb-4 shadow-sm">
          {!scannedToilet ? (
            ...
            >
              ...
              <Text className="text-lg font-semibold mb-1" style={{ fontFamily: getFontFamily('sans'), color: primaryBlue }}>
                Scan Toilet QR
              </Text>
              <Text className="text-sm text-grayText text-center" style={{ fontFamily: getFontFamily('sans') }}>
            ...
            <View>
              <View className="flex-row justify-between items-center mb-3">
                <Text className="text-sm text-grayText" style={{ fontFamily: getFontFamily('sans') }}>
                  Scanned Toilet
                </Text>
              ...
              <View className="flex-row items-center">
                ...
                <View>
                  <Text className="text-lg font-semibold" style={{ fontFamily: getFontFamily('sans'), color: primaryBlue }}>
        ...
        {scannedToilet && (
          ...
          >
            <View className="flex-row items-center">
              ...
              <Text className="ml-3 font-semibold" style={{ fontFamily: getFontFamily('sans'), color: primaryBlue }}>
        ...
        {showFeedbackList && scannedToilet && (
          <View className="bg-white rounded-xl p-4 mb-4 shadow-sm">
            <Text className="text-lg font-semibold mb-3" style={{ fontFamily: getFontFamily('serif'), color: primaryBlue }}>
              Recent Feedback
            </Text>
            {feedbacks.length > 0 ? (
        ...
        {scannedToilet && (
          <View className="bg-white rounded-xl p-4 mb-4 shadow-sm">
            <Text className="text-lg font-semibold mb-4" style={{ fontFamily: getFontFamily('serif'), color: primaryBlue }}>
              Select Issue Type
            </Text>
            ...
            {/* Rating Section */}
            <View className="mb-4">
              <Text className="text-sm font-medium mb-2" style={{ fontFamily: getFontFamily('sans'), color: darkBlue }}>
                Overall Rating
              </Text>
            ...
            <View className="mb-4">
              ...
              <TextInput
                ...
                style={{ borderColor: lightGray, fontFamily: getFontFamily('sans'), color: darkBlue }}
            ...
            >
              <Text className="text-white text-center font-semibold text-lg" style={{ fontFamily: getFontFamily('rounded') }}>
                Submit Feedback
              </Text>
            </TouchableOpacity>
          </View>
